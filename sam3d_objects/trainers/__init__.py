...
__attributes = {
    ...
    'Sam3DConditionedMixin': 'flow_matching.mixins.sam3d_conditioned',

    'SSGeneratorTrainer': 'flow_matching.ss_generator',
    'SSGeneratorCFGTrainer': 'flow_matching.ss_generator',
    'Sam3DConditionedSSGeneratorCFGTrainer': 'flow_matching.ss_generator',
...
if __name__ == '__main__':
    ...
    from .flow_matching.mixins.sam3d_conditioned import Sam3DConditionedMixin

    from .flow_matching.ss_generator import (
        SSGeneratorTrainer,
        SSGeneratorCFGTrainer,
        Sam3DConditionedSSGeneratorCFGTrainer,
    )
