...
from ..modules.transformer import (
    ...
    MOTModulatedTransformerGlobalBlock,
)
...
class MidiSparseStructureFlowModel(nn.Module):
    def __init__(
        self,
        in_channels: int,
        model_channels: int,
        ...
        **kwargs,
        ...
        assert num_global_blocks <= num_blocks, "num_global_blocks should be less than or equal to num_blocks"

        print(f'num_blocks: {num_blocks}')
        print(f'num_global_blocks: {num_global_blocks}')
        ...
        # arrange blocks so that global blocks are at the middle of the network
        num_blocks1 = (num_blocks - num_global_blocks) // 2
        num_blocks2 = num_blocks - num_global_blocks - num_blocks1
...
class MidiSparseStructureFlowTdfyWrapper(MidiSparseStructureFlowModel):
    def __init__(
        self,
        latent_mapping: dict,
